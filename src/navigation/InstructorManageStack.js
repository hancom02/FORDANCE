...
import PostSecondProgramView from '../screens/InstructorManage/views/Program/PostSecondProgramView copy';
...
function InstructorManageStack() {
    return (
        <Stack.Navigator initialRouteName="InstructorManageStack" screenOptions={{ headerShown: false }}>
            ...
            <Stack.Screen name="PostProgramSecond" component={PostSecondProgramView} />
