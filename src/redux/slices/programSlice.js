...
const programSlice = createSlice({
    ...
    reducers: { //danh sách các reducer sẽ dùng cho nội bộ đối tượng program
    ...
    extraReducers: (builder) => { //dùng cho việc lắng nghe các action khác ko thuộc programSlice
