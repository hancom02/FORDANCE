...
const InstructorAccountMainView = () => {
    ...
    const [prizes, setPrizes] = useState('Playground LA, The VMAs, The Pussycat Dolls, Tyga, Faouzia, Pia Mia, Kendrick Lamar');
    const [introduce, setIntroduce] = useState(`The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from 'de Finibus Bonorum et Malorum' by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.git`);
    const [coverPhotoUrl, setCoverPhotoUrl] = useState('https://via.placeholder.com/350x150');
        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.profileImgContainer}>
                <ImageBackground
                    ...
                    {isEditing && (<TouchableOpacity style={styles.editCoverPhotoBtn} onPress={handleEditCoverPhoto} >
                ...
                <View style={styles.avatarContainer}>
                    ...
                    {isEditing && (<TouchableOpacity style={styles.editAvatarBtn} onPress={handleEditAvatar}>
                        <Ionicons name="image-outline" size={24} color="black" />
                    </TouchableOpacity>)}
                </View>
            </View>
            <View style={styles.textNameContainer}>
                <Text style={styles.textName}>ALEXIS BEAUREGARD</Text>
            </View>
...
export default InstructorAccountMainView;