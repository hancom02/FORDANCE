...
import createProgram from '../../../../api/program/create';
import SmallerLessonComponent from '../../../../components/SmallerLessonComponent';
import {useCreateProgram} from '../../../../stores/create-program.store';

const PostSecondProgramView = props => {
  const {navigation, route} = props;
  const [selectedItems, setSelectedItems] = useState([]);

  const {name, introduce, level, category, learn, need} = useCreateProgram();
  ...
  const handleSubmit = () => {
    mutate({
      ...
      learn,
      need,
      lessonIds: selectedItems.map(s => s.id),
    });
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.lessonsContainer}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('ChooseLesson')}>
