    ...
    return (
        <TouchableOpacity style={styles.container} onPress={handleNav}>
                ...
                >
                    ...
                    <View style={styles.contentContainer}>
                        <TouchableOpacity
                            onPress={handleNav}
                        >
                            <Ionicons name="calendar-outline" size={24} color={Colors.primaryPupple} />
                        </TouchableOpacity>
                    </View>
            ...
            <View style={styles.container3}>
                <Text numberOfLines={1} ellipsizeMode='middle' style={styles.textTime}>{lessons.timeDuring} minutes</Text>
            </View>
        </TouchableOpacity>
    )
}
